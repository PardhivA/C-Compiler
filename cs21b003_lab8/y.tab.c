...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_if_control = 38,                /* if_control  */
  YYSYMBOL_39_1 = 39,                      /* $@1  */
  YYSYMBOL_else_add_on = 40,               /* else_add_on  */
  YYSYMBOL_41_2 = 41,                      /* $@2  */
  YYSYMBOL_condition = 42,                 /* condition  */
  YYSYMBOL_sub_condition = 43,             /* sub_condition  */
  YYSYMBOL_boolop = 44,                    /* boolop  */
  YYSYMBOL_relop = 45,                     /* relop  */
  YYSYMBOL_stmt = 46,                      /* stmt  */
  YYSYMBOL_EXPR = 47,                      /* EXPR  */
  YYSYMBOL_TERM = 48,                      /* TERM  */
  YYSYMBOL_FACT = 49,                      /* FACT  */
  YYSYMBOL_FIX = 50,                       /* FIX  */
  YYSYMBOL_IDTEMP = 51,                    /* IDTEMP  */
  YYSYMBOL_IDTEMP2 = 52                    /* IDTEMP2  */
};
...
{
       0,    88,    88,    90,    91,    94,    94,   108,   108,   118,
     119,   121,   121,   125,   132,   134,   139,   141,   143,   145,
     147,   149,   151,   153,   156,   164,   165,   176,   188,   189,
     201,   213,   215,   232,   253,   284,   318,   327,   329,   332,
     335,   339,   342,   348
};
#endif
...
static const char *const yytname[] =
{
  ...
  "RELLESSEQUAL", "RELNOTEQUAL", "RELEQUAL", "ELSE", "WHILE", "LBRACE",
  "RBRACE", "IF", "';'", "'('", "')'", "'{'", "'}'", "'='", "'+'", "'-'",
  "'*'", "'/'", "$accept", "slist", "if_control", "$@1", "else_add_on",
  "$@2", "condition", "sub_condition", "boolop", "relop", "stmt", "EXPR",
...
{
       6,   -23,    -6,   -23,    -1,    -1,   -13,    72,    14,    23,
      24,     8,   -11,     1,   -23,   -23,     9,    39,   -23,   -23,
     -23,    47,    -8,    42,   -23,   -23,   -23,   -23,     6,     6,
      72,    72,    72,    72,   -23,    72,   -23,    72,    27,    13,
      71,   -23,    28,   -23,   -23,     1,     1,   -23,   -23,   -11,
     -23,   -23,   -23,   -23,    47,   -23,   -23,   -23,   -23,   -23,
     -23,   -23,   -23,    72,     6,    31,   -23,   -11,    26,     6,
     -23,    32,   -23
};
...
{
       4,    40,    42,    41,     0,     0,     0,     0,     0,     0,
       9,     0,    25,    28,    31,    37,    39,     0,    42,    32,
      34,     0,     0,    39,    36,    39,     1,     7,     4,     4,
       0,     0,     0,     0,    33,     0,    35,     0,     0,    11,
       0,    38,     0,     3,     2,    26,    27,    29,    30,    24,
      12,     5,    15,    14,     0,    16,    23,    18,    20,    19,
      21,    22,    17,     0,     4,     0,    10,    13,     0,     4,
       8,     0,     6
};
...
{
       0,     9,    10,    65,    28,    42,    38,    39,    54,    63,
      11,    12,    13,    14,    15,    23,    17
};
...
{
      16,   -43,    22,    18,    19,    20,    43,    44,    25,     1,
       2,     3,     4,     5,    21,    34,    40,     1,    18,     3,
      41,    30,    31,    26,    30,    31,    52,    53,    16,    16,
      49,     6,    40,     7,    29,    32,    33,    45,    46,     8,
      35,     7,    68,    47,    48,    27,    36,    71,    34,    40,
       1,     2,     3,     4,     5,    51,    70,    64,    67,    37,
      69,    24,    72,     0,    16,     0,    66,    50,     0,    16,
       0,     0,     0,     0,     7,     1,     2,     3,     4,     5,
       8,    55,    56,     0,     0,     0,    57,    58,    59,    60,
      61,    62,     0,     0,     0,     0,     0,     0,     0,     7,
       0,     0,     0,    30,    31,     8
};

static const yytype_int8 yycheck[] =
{
       0,     7,     7,     4,     4,     5,    28,    29,     8,     3,
       4,     5,     6,     7,    27,     6,    21,     3,     4,     5,
      28,    32,    33,     0,    32,    33,    13,    14,    28,    29,
      35,    25,    37,    27,    26,    34,    35,    30,    31,    33,
      31,    27,    64,    32,    33,    21,     7,    69,     6,    54,
       3,     4,     5,     6,     7,    28,    30,    29,    63,    12,
      29,     8,    30,    -1,    64,    -1,    54,    37,    -1,    69,
      -1,    -1,    -1,    -1,    27,     3,     4,     5,     6,     7,
      33,    10,    11,    -1,    -1,    -1,    15,    16,    17,    18,
      19,    20,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    27,
      -1,    -1,    -1,    32,    33,    33
};
...
{
       0,     3,     4,     5,     6,     7,    25,    27,    33,    37,
      38,    46,    47,    48,    49,    50,    51,    52,     4,    51,
      51,    27,    47,    51,    50,    51,     0,    21,    40,    26,
      32,    33,    34,    35,     6,    31,     7,    12,    42,    43,
      47,    28,    41,    37,    37,    48,    48,    49,    49,    47,
      43,    28,    13,    14,    44,    10,    11,    15,    16,    17,
      18,    19,    20,    45,    29,    39,    42,    47,    37,    29,
      30,    37,    30
};
...
#line 1332 "y.tab.c"
  ...
  case 8: /* else_add_on: ELSE $@2 '{' slist '}'  */
#line 115 "prob1.y"
        {
		printf("%s: " , stack[stack_count-1]); stack_count--;
	}
#line 1340 "y.tab.c"
  ...
  case 9: /* else_add_on: %empty  */
#line 118 "prob1.y"
          { printf("%s: " , stack[stack_count-1]); stack_count--;}
#line 1346 "y.tab.c"
    break;

  case 10: /* condition: sub_condition boolop condition  */
#line 119 "prob1.y"
...
#line 1369 "y.tab.c"
  ...
  case 13: /* sub_condition: EXPR relop EXPR  */
#line 125 "prob1.y"
                               {
		(yyval.String) = (char*)malloc(40 *sizeof(char));
		strcpy((yyval.String),gen_var()); 
